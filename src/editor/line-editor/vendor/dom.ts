...
// needs these two helpers to implement WidgetType.coordsAt. Neither is part
// of the @codemirror/view public API, so there's nothing to import. Kept
// verbatim so it stays easy to diff against upstream.
