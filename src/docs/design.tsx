...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      <_components.h1>{'Design'}</_components.h1>
      {'\n'}
      ...
      <_components.ul>
        {'\n'}
        <_components.li>
          <_components.a href="https://antirez.com/news/51">
            {'Log driven programming'}
          </_components.a>
        </_components.li>
        {'\n'}
        <_components.li>
          <_components.a href="https://bulletjournal.com/pages/book">
            {'The bullet journal method'}
          </_components.a>
        </_components.li>
        {'\n'}
        <_components.li>
          <_components.a href="https://davidcain.gumroad.com/l/howtodothings/2024isover">
            {'How to do things'}
          </_components.a>
        </_components.li>
        {'\n'}
...
export default function DesignWrapper(props: DesignProps = {}) {
  ...
  return <Design {...props} components={customComponents} />
}
