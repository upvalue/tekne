...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      <_components.h3>{'Getting Started'}</_components.h3>
      {'\n'}
      <_components.p>
        {
      ...
      <_components.p>
        ...
        <_components.code>{'Cmd-K'}</_components.code>
        {') to start it again.'}
      </_components.p>
      {'\n'}
      ...
      {'\n'}
      <_components.p>
        {'For help using the editor, check out the '}
        <_components.code>{'Editor Syntax'}</_components.code>
        {' and '}
        <_components.code>{'Keyboard Shortcuts'}</_components.code>
        {' help\narticles.'}
      </_components.p>
      {'\n'}
