...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      <_components.h3>{'Development'}</_components.h3>
      {'\n'}
      <_components.p>
        {
      ...
      {'\n'}
      <_components.h4>{'Running'}</_components.h4>
      {'\n'}
      <_components.p>
        {
      ...
      {'\n'}
      <_components.p>
        {'To run a postgres database (via '}
        <_components.code>{'docker-compose.yml'}</_components.code>
        {'), the server and client all at once.'}
      </_components.p>
      {'\n'}
      <_components.h4>
      ...
      <_components.p>
        {
          "There's currently a very alpha Docker image based on Alpine that can be used to deploy the\napplication to production. The only required environment variable you'll need to set in that case is\n"
        }
        <_components.code>{'DATABASE_URL'}</_components.code>
        {' to a postgres database URL (see '}
        <_components.code>{'package.json'}</_components.code>
        {' for an example)'}
      </_components.p>
      {'\n'}
      <_components.p>
        {'Database access is with kysely; with '}
        <_components.code>{'DATABASE_URL'}</_components.code>
        {' set, use'}
      </_components.p>
      {'\n'}
      ...
      {'\n'}
      <_components.p>
        {"There's a bit more detail about the setup albeit scattered in "}
        <_components.code>{'CLAUDE.md'}</_components.code>
      </_components.p>
    </>
  )
}
